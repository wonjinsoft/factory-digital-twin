...
export function AlarmPanel() {
  ...
  return (
    <div className="order-first md:order-none w-full shrink-0 max-h-48 md:max-h-none md:w-72 bg-white/[0.02] border-b md:border-b-0 md:border-l border-white/7 p-4 md:p-5 overflow-y-auto">
      {/* 헤더 */}
